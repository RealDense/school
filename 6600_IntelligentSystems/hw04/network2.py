...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in range(epochs):
            ...
            print (" ")
            if(len(evaluation_accuracy) >= 3):
                if (abs(evaluation_accuracy[-1] - evaluation_accuracy[-3]) < 10):
                    break
                if(training_cost[-1] < training_cost[-3] and evaluation_cost[-1] > evaluation_cost[-3]):
                    break
