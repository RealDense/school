...
def build_tflearn_convnet_3():
    ...
    # convolutional layer of 40 20x20 features
    ...
    # convolutional layer of 80 16x16 features
    conv_layer_3 = conv_2d(pool_layer_2,
                       nb_filter=80,
                       filter_size=5,
                       activation='relu',
                       name='conv_layer_3')
    # convolutional layer of 80 8x8 features
...
SAVE_CONVNET_PATH = 'hw06_my_net_03.tfl'
