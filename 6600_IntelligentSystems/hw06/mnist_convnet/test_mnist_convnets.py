...
net_path_2 = 'hw06_my_net_02.tfl'
net_path_3 = 'hw06_my_net_03.tfl'
net_path_4 = 'hw06_my_net_04.tfl'
net_path_5 = 'hw06_my_net_05.tfl'
...
def load_mnist_convnet_1(path):
    ...
    conv_layer_1  = conv_2d(input_layer,
                            ...
                            activation='relu',
                            name='conv_layer_1')
    pool_layer_1  = max_pool_2d(conv_layer_1, 2,
                                name='pool_layer_1')
    conv_layer_2 = conv_2d(pool_layer_1,
                           ...
                           activation='relu',
                           name='conv_layer_2')
    pool_layer_2 = max_pool_2d(conv_layer_2, 2,
                               name='pool_layer_2')
...
if __name__ == '__main__':
    print('ConvNet 1 accuracy = {}'.format(test_tflearn_convnet_model(net_model_2, validX, validY)))

# let's test the persisted network on 20
# randomly selected validation samples.
model = load_mnist_convnet_1(net_path_2)
tests = []
num_tests = 20
